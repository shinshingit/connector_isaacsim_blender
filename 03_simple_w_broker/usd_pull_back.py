...
BASE_USD = r"C:/work/blender_out/base.usdc"   # broker の root.usda が参照している base
EXPORT_OPTIONS = {
...
# 再実行しても二重登録にならないよう、参照をここに保持する
NS = bpy.app.driver_namespace
STATE = NS.setdefault("_usd_sync_state", {})
...
def _on_save_post(_dummy=None, _dummy2=None):
    ...
    try:
        meta = fetch("/stage", POLL_TIMEOUT_SEC, reload=1)
